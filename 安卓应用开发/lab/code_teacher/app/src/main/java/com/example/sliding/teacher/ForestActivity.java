...
public class ForestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int time;
    private String num;
    private List<Student> forest_student;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        handle(str);
        if (forest_student.size() != 0)    {
            textView.setText("Last_number:"+forest_student.size()+"/30");
        }
        else{
    ...
    private void handle(String str){
        Gson gson = new Gson();
        forest_student = gson.fromJson(str,new TypeToken<List<Student>>(){}.getType());
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (edit_time.getText().toString()!=null)  a.putExtra("time", Integer.valueOf(edit_time.getText().toString()));
